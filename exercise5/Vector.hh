...
namespace scprog
{
    ...
    public:
        ...
        Vector& operator/= (value_type const k);  // scalar division
    ...
    Vector operator* (Vector::value_type k, Vector v);  // scalar multplication from left
    Vector operator* (Vector v, Vector::value_type k);  // scalar multplication from right
    Vector operator/ (Vector v, Vector::value_type k);  // scalar division from right
